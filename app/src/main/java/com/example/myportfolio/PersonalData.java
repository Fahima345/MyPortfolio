...
public class PersonalData extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bio.setText("My Name is Fahima Chowdhury. I am studying Computer Programmer Analyst at Georgebrown College. I'm almost done for my " +
                ...
                "We have to work hard in order to achive our goal.");
